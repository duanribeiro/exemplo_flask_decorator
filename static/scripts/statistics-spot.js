    ...
    var app = new Vue({
        ...
        methods:{
            open_transact_info_popup(op_day) {
                window.open('/fxspot/statistics-spot-day-popup?day=' + op_day, "", "width=800,height=640");
            },
            processCurrency(num) {
                return processFloatNumber(num)
            },
            open_reject_info_popup(op_day) {
                window.open('/fxspot/statistics-spot-day-reject-popup?day=' + op_day, "", "width=800,height=640");
            },
        },
        beforeMount() {},
    });
